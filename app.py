...
# Fix for ReportLab OpenSSL md5 compatibility issue
try:
    _original_md5 = hashlib.md5
    def _patched_md5(*args, **kwargs):
        # Remove the offending argument if present
...
if st.button("🚀 Generate Plan"):
    ...
    with st.spinner("Reading your syllabus..."):
        ...
        os.unlink(tmp_path)  # Clean up the file right after extraction
    ...
    with st.spinner("Building your 7 days plan..."):
        ...
        # FIXED: Indented the remaining extraction lines into the button execution flow
